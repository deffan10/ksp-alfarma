...
var canvasEl2 = document.getElementById("myChart2");
if (canvasEl2 && canvasEl2.getContext) {
  var ctx = canvasEl2.getContext('2d');
  var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
      labels: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
...
var canvasEl3 = document.getElementById("myChart3");
if (canvasEl3 && canvasEl3.getContext) {
  var ctx = canvasEl3.getContext('2d');
  var myChart = new Chart(ctx, {
    type: 'line',
    data: {
      labels: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
