...
{!! Form::open(array('url'=>'nasabah', 'files'=>'true')) !!}
    <table class='table table-bordered table-responsive-sm'>
        <tr><td>Nomor Rekening</td><td>{!! Form::text('no_rekening','',['class'=>'form-control','maxlength'=>'','required']) !!}</td></tr>
        ...
        <tr><td>No KTP</td><td>{!! Form::text('no_ktp','',['class'=>'form-control','maxlength'=>'16','required']) !!}</td></tr>
